...
- `assets/reports` — reports generated by their respective PHP files, downloaded directly from the webpage
- `assets/screenshots` — screenshots showing the main website functionality
